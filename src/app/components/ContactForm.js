          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            <form className="space-y-6">
              ...
              <div className="flex items-center">
                <input
                  type="checkbox"
                  className="form-checkbox h-4 w-4 text-yellow-400 rounded"
                />
              ...
              <div>
                <button
                  type="submit"
                  className="w-full bg-yellow-400 hover:bg-yellow-500 text-gray-950 font-bold py-3 px-4 rounded-md transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg"
                >
                  Submit
                </button>
              </div>
          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p className="text-gray-600">
                  Address: Unit A, 3210 Mavis Rd, Mississauga L5C 1W2
                  <br />
                  Email: info@example.com
                  <br />
                  Call Us: 289-497-8989
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-950 mb-2">
                ...
                <p className="text-gray-600">
                  Address: 449 Mount Pleasant Rd Brantford, ON N3T 5L5
                  <br />
                  Email: brantford@example.com
                  <br />
                  Call Us: 1-888-799-4622
                </p>
              </div>
            </div>
